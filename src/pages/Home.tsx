...
const inScope = [
  { to: '/counts', title: 'Count-In / Count-Out', desc: 'Artists + Vendors toggle, Initial/Ending counts, Comp + Shrink, re-up log, item drawer, two-stage sign-off.' },
  { to: '/reconciliation', title: 'Reconciliation', desc: 'Per-SKU Initial + POS + Ending → variance. Editable POS, $ summary, SKU vs overall views, resolution levers.' },
  { to: '/settlement', title: 'Settlement & Payout', desc: 'Locked fees, +/− custom lines, editable contact & banking, 2-day Stripe payout, money buckets.' },
  { to: '/vendor-portal', title: 'Vendor / Artist Portal', desc: 'e-signature settlement, Finalized Settlements, label upload, my-people routing, live sales.' },
  ...
  { to: '/configurations', title: 'Configurations', desc: 'Contracted fee rates locked pre-event; permission tiers; sign-off flags.' },
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', gap: 18, padding: '32px 0 20px', borderBottom: `1px solid ${t.cardBorder}` }}>
          ...
          <div style={{ paddingBottom: 4 }}>
            ...
            <div style={{ fontSize: 13, color: t.secondary2, marginTop: 6 }}>
              Working front-end demo · Furnace Fest 2026 · count-in/out → reconciliation → settlement &amp; payout
            </div>
          </div>
        </div>
